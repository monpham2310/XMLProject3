...
<div class="row">
    ...
    <div class="col-md-2 form-group">
        <span class="pagebtnw">	
            <button type="button" class="btn">Xuất XML</button></span>
    </div>
    <div class="col-md-2 form-group">
        <span class="pagebtnw">	
            <button type="button" class="btn">Xuất word</button></span>
    </div>
    <div class="col-md-2 form-group">
        <span class="pagebtnex">	
            <button type="button" class="btn">Xuất Excel</button></span>
    </div>
</div>
